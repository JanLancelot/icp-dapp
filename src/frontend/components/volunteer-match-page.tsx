    ...
    <div className="min-h-screen bg-gray-50">
      <main className="container mx-auto px-4 py-8">
        ...
        {/* <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-4">You will need</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-600">
            <li>Have your mission statement and organization description handy</li>
            <li>If you are a 501(c), be sure to have your EIN ready</li>
          </ul>
        </section> */}
